...
import { collection, collectionGroup, docData, Firestore, query, where } from '@angular/fire/firestore';
...
import { RegisterPageForm } from '../register/register.page.form';
...
export class LoginPage implements OnInit, OnDestroy {
  ...
  constructor(private route:Router, private formBuilder: FormBuilder, private store: Store<AppState>,
    private toastController: ToastController, private authService: AuthService, private dataService: DataService,
